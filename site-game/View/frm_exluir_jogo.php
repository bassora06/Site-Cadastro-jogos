      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
                 <form action="../Controller/excluir_jogo.php" method="post" class="form-box">
                    <h3 class="h4 text-black mb-4">Excluir jogo</h3>
                    <div class="form-group">
                      <input type="number" class="form-control" placeholder="id" name="id" required>
                    </div><br>
                    <div class="form-group">
                      <center><input type="submit" class="get-started-btn" value="Excluir jogo" name="botao"></center>				
					</form>					
						</div>
					</form>		
          </div>
