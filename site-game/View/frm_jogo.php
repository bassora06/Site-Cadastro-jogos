      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
                 <form action="../Controller/controller_cadastrar_jogo.php" method="post" class="form-box">
                    ...
                    <div class="form-group">
                      <center><input type="submit" class="get-started-btn" value="Registrar jogo" name="botao"></center>				
					</form>					
						</div>
					</form>		
          </div>
