...
<header id="header" class="fixed-top">
  ...
  <section id="contact" class="contact">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <table>
      <tr> 
        <th width="1000">Numeros de jogos cadastrados</th>
      </tr>  
  ...
  <?php 
    ...
    $conn= conectar();  
     ...
     $conectados = "SELECT COUNT(id) AS id FROM game";
...
>
  ...
  $game = "SELECT * FROM game ORDER BY id";
 ...
 ?>
  <tr >
	...
	<td><?php echo $row_game['genero'];?></td>
	<td><?php echo $row_game['id'];?></td>
	<td><?php echo $row_game['preco'];?></td>
  </tr>
  <?php }?>
...
<!-- ======= inicio da tabela 3 ======= -->
    <section id="contact" class="contact">
      ...
      <tr 
>
        <th width="1000">Biblioteca de jogos separados de A a Z </th>
  ...
  $conectados = "SELECT * FROM game GROUP BY nome";
 ...
 <!-- ======= inicio da tabela 4 ======= -->
    <section id="contact" class="contact">
      ...
      <tr 
>
        <th width="300">Biblioteca de jogos separados pelo id crescente </th>
